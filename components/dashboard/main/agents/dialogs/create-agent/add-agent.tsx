                  ...
                  <div className="flex flex-col gap-4 pb-2">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <Label>
                            {f.labels.agency} <span className="text-destructive">*</span>
                          </Label>
                          <Select
                          ...
                          >
                            <SelectTrigger className="w-full">
                              <SelectValue
                                placeholder={agenciesLoading ? f.placeholders.loadingAgencies : f.placeholders.selectAgency}
                              />
                            </SelectTrigger>
                            <SelectContent>
                              {agencies.map((agency) => (
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <Label>
                              {f.labels.fullName} <span className="text-destructive">*</span>
                            </Label>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <Label>
                              {f.labels.title} <span className="text-destructive">*</span>
                            </Label>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <Label>
                              {f.labels.nationality} <span className="text-destructive">*</span>
                            </Label>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <Label>
                            {f.labels.languages} <span className="text-destructive">*</span>
                          </Label>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <Label>
                            {f.labels.brokerLicense} <span className="text-destructive">*</span>
                          </Label>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <Label>
                              {f.labels.yearsExp} <span className="text-destructive">*</span>
                            </Label>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <Label>
                              {f.labels.since} <span className="text-destructive">*</span>
                            </Label>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <Label>
                              {f.labels.responseMin} <span className="text-destructive">*</span>
                            </Label>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <Label>
                              {f.labels.rating} <span className="text-destructive">*</span>
                            </Label>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <Label>
                              {f.labels.ratingsCount} <span className="text-destructive">*</span>
                            </Label>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <Label>
                            {f.labels.photo} <span className="text-destructive">*</span>
                          </Label>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <Label>
                            {f.labels.photoGradient} <span className="text-destructive">*</span>
                          </Label>
                          <Select onValueChange={field.onChange} value={field.value}>
                            <SelectTrigger className="w-full">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <Label>
                              {f.labels.agencyAccent} <span className="text-destructive">*</span>
                            </Label>
                            <Select onValueChange={field.onChange} value={field.value}>
                              <SelectTrigger className="w-full">
                                <div className="flex items-center gap-2 min-w-0">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <Label>
                              {f.labels.agencyMonogram} <span className="text-destructive">*</span>
                            </Label>
                    ...
                    <FormField
                      ...
                      render={({ field }) => {
                        ...
                        return (
                          <FormItem>
                            <Label>
                              {f.labels.bio} <span className="text-destructive">*</span>
                            </Label>
                            <Textarea
                              {...field}
                              value={field.value ?? ""}
